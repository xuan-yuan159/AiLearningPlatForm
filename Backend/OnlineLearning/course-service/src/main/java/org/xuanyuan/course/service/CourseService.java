...
public interface CourseService extends IService<Course> {
    ...
    Page<Course> getPublicCourseList(Integer page, Integer size, String category, String keyword);

    Course getPublicCourseDetail(Long courseId);

    PublicCourseCatalogResp getPublicCourseCatalog(Long courseId);
}
